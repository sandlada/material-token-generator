import { SchemeContent, Hct, hexFromArgb, DynamicScheme } from "@material/material-color-utilities";
import { IMaterialGeneratorOptions, EMaterialContrastLevel } from ".";
import { MaterialColors, TMaterialColors } from "./material-colors";
...
export class MaterialTokensGenerator {
    ...
    public static GenerateBySourceColor(
      sourceColor: number,
      options: Partial<IMaterialGeneratorOptions>
    ): TMaterialColors {
  ...
  export class MaterialSchemaGenerator {
    ...
    public static GenerateBySourceColor(
      options: Partial<IMaterialGeneratorOptions> &
        Pick<IMaterialGeneratorOptions, 'sourceColor'> & {
          cl: Array<number>;
        }
    ) {
